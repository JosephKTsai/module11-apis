...
# We can call them by their name or by their id
movie <- c("charizard")

# Make a variable called pokemon url that holds your favorite pokemon's url 
pokemon.url <- paste0(base.url, "pokemon/", movie)

# Use the GET function to call the url, store it in a variable called response
response <- GET(pokemon.url)

# Use the names function to learn more about response. Print it out. It will return a list of ten 
...
# hint: remember you can call this similar to how you would call a column!
